...
('Rework_Decision', (['Logic_board', 'IO_board'], [0, 1]))
('Logic_board_fail', (['Yes', 'No'], [0, 1]))
('IO_board_fail', (['Yes', 'No'], [0, 1]))
('System_State', (['Failed', 'Operational'], [0, 1]))
('Rework_Outcome', (['L0_IO0', 'L0_IO1', 'L1_IO0'], [0, 1, 2]))
...
partial_order = [
    ...
    ('chance', ['IO_board_fail']),    
    ('chance', ['Logic_board_fail']),
    ('chance', ['Rework_Outcome']),    
]