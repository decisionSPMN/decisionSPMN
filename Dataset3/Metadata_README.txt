...
('CT', (['Yes', 'No'], [0, 1]))
('Treatment', (['Thoracotomy', 'Radiation_therapy'], [0, 1]))
('CTResult', (['Positive', 'NA', 'Negative'], [0, 1, 2]))
('Mediastinal_Metastases', (['No', 'Yes'], [0, 1]))
('Mediastinoscopy_Result', (['Negative', 'NA', 'Positive'], [0, 1, 2]))
('Mediastinoscopy', (['Yes', 'No'], [0, 1]))
('Treatment_Death', (['No', 'Yes'], [0, 1]))
('Mediastinoscopy_death', (['No', 'Yes'], [0, 1]))
...
partial_order = [
    ('decision', 'Mediastinal_Metastases'),
    ('chance', ['CT']),    
    ('decision', 'CTResult'),
    ('chance', ['Mediastinoscopy']),        
    ('decision', 'Mediastinoscopy_Result'),    
    ('chance', ['Treatment']),
    ('decision', 'Treatment_Death'),
    ('decision', 'Mediastinoscopy_death'),
]