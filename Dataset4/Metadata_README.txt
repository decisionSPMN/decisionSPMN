...
('Screen', (['Yes', 'No'], [0, 1]))
('Treat_Counsel', (['Yes', 'No'], [0, 1]))
('HIV_Test_Result', (['HIV_Neg', 'NA', 'HIV_Pos'], [0, 1, 2]))
('HIV_Status', (['Negative', 'Positive'], [0, 1]))
('Compliance_Medical_Therapy', (['Yes', 'No'], [0, 1]))
('Reduce_Risky_Behavior', (['Yes', 'No'], [0, 1]))
...
partial_order = [
    ('decision', 'Screen'),    
    ('chance', ['HIV_Test_Result']), 
    ('decision', 'Treat_Counsel'),
    ('chance', ['HIV_Status']),
    ('chance', ['Compliance_Medical_Therapy']),
    ('chance', ['Reduce_Risky_Behavior']),
]